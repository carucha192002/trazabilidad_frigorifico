$(document).ready(function(){
    $('#gestion_resultadosproductor1').addClass('active');
    let funcion;
    ...
    function mostrar_consultas(){
        funcion="id_matarife";
        let identificador=$('#matarifeid').val();
     ...
     async function faena_mes_matarife(){
        let array=['','','','','','','','','','','',''];
        let idmatarife= $('#productormatarife').val();
        funcion='faena_mes_matarife';
        const response = await fetch('../controlador/GraficoControllerMatarife.php',{
            method: 'POST',
    ...
    async function faena_mes_anterior_productor(){
        ...
        funcion='faena_mes_matarife';
        let idmatarife1=$('#productormatarife').val();
        let lista1=['','','','','','','','','','','',''];
        const response1 = await fetch('../controlador/GraficoControllerMatarife.php',{
            method: 'POST',
            headers:{'Content-Type':'application/x-www-form-urlencoded'},
