...
<div class="login-box">
  <div class="login-logo">
    <a href="../index.php"><b>Matadero Frigorifico Municipal </b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Olvidaste tu contraseña? Aqui la puedes recuperar!.</p>
      ...
      <p class="login-box-msg mt-3">Se le enviara un Codigo a su Email</p>
